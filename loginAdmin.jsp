<%-- 
    Document   : loginAdmin
    Created on : 16-mag-2020, 17.01.55
    Author     : condor
--%>
    ...
    <body>
        ...
        <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="index.jsp">Torna all'area di UserLogin</a> 
                    </li>
                </ul>
        ...
        <form action="${pageContext.request.contextPath}/LoginAdmin" method="POST"> 
            <h5 class="oggetti">Username Admin</h5> 
            <input type="text" name="username"class="form-control"/>
            <h5 class="oggetti">Password Admin</h5> 
